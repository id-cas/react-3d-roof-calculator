	...
	THREE.ColladaExporter.prototype = {
		...
		parse: function ( object, onDone, options ) {
			...
			function processTexture( tex ) {
				...
				if ( texid == null ) {
					...
					textures.push( {
						...
						name,
						ext,
						// data: imageToData( tex.image, ext ),	// Source variant
						data: (tex.image instanceof ImageData) ? tex.image.data : imageToData( tex.image, ext ),
						original: tex
					} );
			...
			function processObject( o ) {
				...
				// Mod: 2021-04-22 Chugaynov A.S.
				if(onlyVisible && !o.visible){
					return;
				}
